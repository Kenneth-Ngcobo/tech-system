...
<div>
    ...
    <form-wizard title="" subtitle=""  ref="wizard" @on-complete="onComplete">
        ...
        <tab-content title="NCR Info" :before-change="validateInfo">
            ...
            <div class="form-group">
                <label class="col-md-2">Original SO/Inv No</label>
                <input type="text" v-model="ncr.orig_so">
            </div>
            <div class="form-group">
                <label class="col-md-2">Maintenance SO</label>
                <input type="text" v-model="ncr.so">
            </div>
            <div class="form-group">
                <label class="col-md-2">Date Manufactured</label>
            ...
            <div v-if="ncr.type == 'Site'">
             ...
             <div class="form-group">
                <label class="col-md-2">Project/Site Name</label>
        ...
        <tab-content title="Failed Products" :before-change="beforeChange">
            <div  class="row">
               ...
               <validation-observer v-slot="{handleSubmit}"> 
                <form @submit.prevent="handleSubmit(addProd)">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <validation-provider  rules="required" v-slot="{ errors }">
                        <label class="col-md-4">Issue Category</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="" id="" cols="40" rows="3" v-model="product.failure"></textarea>
                        <span class="required">{{ errors[0] }}</span>
                        </validation-provider>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-md-4">Components</label>
                        <input style="width:250px" type="text" v-model="component.name">
                    ...
                    <div class="form-group">
                        ...
                        <b-button @click="addComp()">Add</b-button>
                    </div>
                    <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                    ...
                    <b-button style="margin-left:34%" type="submit">Add Product</b-button>
                 </form>
               </validation-observer>
                 ...
                 <table class="table table-bordered "> <!--table-striped-->
                     ...
                     <tbody>
                         <tr v-for="(product1,index) in products" :key="index">
                             <td v-if="edit != `prod_name${index}`" @dblclick="edit = `prod_name${index}`"  style="width:25%;">{{product1.name}}</td>
                             <td v-else  style="width:25%;"><input type="text" v-model="product1.name"  style="width:100%;"></td>
                             <td  v-if="edit != `prod_qty${index}`" @dblclick="edit = `prod_qty${index}`" style="width:10%">{{product1.qty}}</td> 
                             <td v-else style="width:10%"><input type="text" v-model="product1.qty" style="width:100%"></td>
            ...
            if(this.ncr.type.length == 0) {
                ...
                if(this.ncr.type == 'Internal') {
                    if(this.ncr.department.length == 0) {
                         alert('Please select NCR department')
                         return false
                    }
                    else {
                        return true
                ...
                if(this.ncr.type == 'Site') {
                    if(this.ncr.orig_so.length == 0) {
                         alert('Please enter original SO/INV No')
                         return false
                    }
                    
                   else if(this.ncr.region.length == 0) {
                        alert('Please select region')
                        return false
                    }
                    else if(this.ncr.project.length == 0) {
                         alert('Please enter site/project name')
                         return false
                    }
                    else {
                        return true
